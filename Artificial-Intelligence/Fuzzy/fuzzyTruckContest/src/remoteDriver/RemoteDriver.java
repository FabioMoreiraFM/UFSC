...
public class RemoteDriver {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while ((fromServer = in.readLine()) != null) {
        	...
        	String fileName = "fuzzify.fcl";
        	FIS fis = FIS.load(fileName, true);
        	
        	fb = fis.getFunctionBlock(null);
        	
        	//Set inputs
        	fb.setVariable("coord_x", x);
        	fb.setVariable("coord_y", y);
        	fb.setVariable("angleTruck", angle);
        	
        	// Evaluate
        	fb.evaluate();
        				
        	double teste = fb.getVariable("virarVolante").getValue();        	
